...
const ManageTransaction = () => {
    ...
    const ManageD = () => {
        ...
        return (
            <div className='px-6 p-4 md:p-6 bg-white rounded-lg shadow-lg'>
                <h1 className='text-3xl md:text-4xl font-bold text-gray-800 text-center py-4 border-b border-gray-200 mb-4'>Lịch sử nạp tiền</h1>
