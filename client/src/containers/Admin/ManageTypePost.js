                ...
                <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center">
                    <div className="bg-white p-6 rounded-lg w-11/12 md:w-1/3">
                        ...
                        <div className="flex justify-end">
                            <button
                                className="bg-gray-500 hover:bg-gray-600 transition duration-300 text-white px-4 py-2 rounded-md mr-2"
                                onClick={closeModalCreate}
                            >
                                Hủy
                            </button>
                            <button
                                className="bg-green-500 hover:bg-green-600 transition duration-300 text-white px-4 py-2 rounded-md"
