...
// import { InputForm, Button, InputFormValidatemail } from '../../components';
...
//             if (isRegister && response.err === 0) {
//                 // Nếu đang đăng ký và mã xác thực được gửi thành công
...
//                 });
//             } else if (!isRegister && response?.payload?.token) {
//                 // Nếu là đăng nhập và token có trong phản hồi
...
//         try {
//             // Gọi API `/register/:codeMail` để xác thực mã
...
//                             invalidFields={invalidFields}
//                             label={'Mã xác minh'}
//                             value={verificationCode}  // Giá trị được lấy từ state
//                             setValue={(e) => setVerificationCode(e.target.value)}  // Cập nhật state khi người dùng nhập liệu
