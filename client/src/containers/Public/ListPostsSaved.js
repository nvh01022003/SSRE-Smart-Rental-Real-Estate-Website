...
//             // Fetch the updated list of saved posts after deletion
//             await dispatch(fetchSavedPosts(token, page));
//         } else {
...
//         // Check for the type parameter to distinguish between pagination types
//         if (searchParamsObject.type === 'saved') {
//             dispatch(fetchSavedPosts(token, searchParamsObject.page));
//         } else {
//             // Handle other types of pagination if needed
//         }
