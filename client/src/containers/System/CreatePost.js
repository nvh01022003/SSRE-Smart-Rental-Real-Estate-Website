...
const CreatePost = () => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            } else if (error.response.status === 400 && error.response.data.err === 1 && error.response.data.msg === 'No file uploaded') {
                setErrorMessage('Ảnh không được để trống'); // Set error message
            }
                ...
                <div className='py-4 flex flex-col gap-8 flex-auto'>
                    ...
                    <div className='w-full mb-6'>
                        ...
                        <div className='w-full'>
                            ...
                            {errorMessage && <p className='text-red-500'>{errorMessage}</p>} {/* Conditionally render error message */}
