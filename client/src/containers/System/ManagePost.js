        ...
        <div className='container mx-auto px-4 py-8'>
            ...
            <div className='bg-white shadow-md rounded-lg p-6'>
                ...
                <div className='flex flex-col md:flex-row items-center justify-center'>
                    <div className='relative mb-4 md:mr-4 w-full md:w-1/2'> {/* Thay đổi chiều rộng cho di động */}
                        <input
                            type="text"
                            ...
                            style={{ maxWidth: '600px' }} // Giới hạn chiều rộng tối đa
                            value={search}
                    ...
                    <div className='mb-4 md:mr-4 w-full md:w-1/3'> {/* Thay đổi chiều rộng cho di động */}
                        <select
                            value={selectedCategory}
                            onChange={handleCategoryChange}
                            className='px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 w-full' // Thêm w-full để dropdown chiếm toàn bộ chiều rộng
                        >
                    ...
                    <button
                        ...
                        className="bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded transition duration-300 flex items-center mb-4 md:mb-0 md:mr-4"
                    >
